...
## Repository map
- `admin_backup_legacy/` — explain what lives here and when agents should edit it.
- `ADMIN_POSTS_README.md/` — explain what lives here and when agents should edit it.
- `app/` — explain what lives here and when agents should edit it.
- `ATUALIZACAO_SENHA_COMPLETA.md/` — explain what lives here and when agents should edit it.
- `CHECKLIST_MIGRACAO.md/` — explain what lives here and when agents should edit it.
- `CLAUDE.md/` — explain what lives here and when agents should edit it.
- `COMANDOS_RAPIDOS.md/` — explain what lives here and when agents should edit it.
- `COMECE_AQUI.md/` — explain what lives here and when agents should edit it.
