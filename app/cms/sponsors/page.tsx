    ...
    const columns = [
        {
            ...
            render: (item: any) => (
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded bg-white p-1 flex items-center justify-center border border-slate-800">
                        {item.logo_url ? <img src={item.logo_url} className="max-w-full max-h-full object-contain" /> : <ImageIcon className="text-slate-300 w-4 h-4" />}
                    </div>
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight text-white">Patrocinadores</h1>
                    <p className="text-slate-400 text-sm mt-1">Gerencie os logotipos e parceiros exibidos no site.</p>
                </div>
                <Button
                    onClick={() => {
                ...
                <div className={cn(
                    ...
                    <form onSubmit={handleSave} className="space-y-4">
                        <div className="space-y-2">
                            <Label className="text-slate-500 text-[10px] font-bold uppercase">Nome da Empresa</Label>
                            <Input
                        ...
                        <div className="space-y-2">
                            <Label className="text-slate-500 text-[10px] font-bold uppercase">Logo URL</Label>
                            <Input
                        ...
                        <div className="space-y-2">
                            <Label className="text-slate-500 text-[10px] font-bold uppercase">Endereço Web</Label>
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className="pl-8 bg-slate-950 border-slate-800 text-slate-300"
                                />
                            </div>
                        </div>
